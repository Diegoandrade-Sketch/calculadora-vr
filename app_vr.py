...
def carregar_dados_vendas():
    try:
        ...
        # Filtros mantidos conforme o código original estável
...
# Chaves do Mapeamento (Adicionado m_app e m_connect conforme solicitado)
...
def aplicar_mapeamento():
    ...
    # Semanas (Implantação + Alimentação + Hospedagem)
...
if tela == "Gerador de Proposta":
    if not modo_apresentacao:
        ...
        # COLUNAS DE SELEÇÃO MANUAL (EXATAMENTE COMO NO SEU CÓDIGO ESTÁVEL)
