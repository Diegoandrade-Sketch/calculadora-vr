...
# --- MÓDULO SIDEBAR (PAINEL DE CONTROLE) ---
with st.sidebar:
...
if tela == "Gerador de Proposta":
    if not modo_apresentacao:
        ...
        # PARTE 1: MAPEAMENTO DA OPERAÇÃO (VISUAL)
        if mapeamento_ativo:
...
# MÓDULO: CONSULTA DE PREÇO (ANÁLISE TÉCNICA)
