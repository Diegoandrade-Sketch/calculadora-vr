...
# 2. Estilização CSS (Repaginada com Degrades Laranja)
st.markdown("""
    <style>
    /* Fundo da página com degradê sutil */
    .stApp {
    ...
    /* Headers das seções com degradê laranja */
    .section-header {
        display: flex;
    ...
    /* Cards com sombra suave para destacar do fundo degradê */
    .resumo-card {
        background-color: #ffffff;
...
with col1:
    ...
    placeholder_imp.markdown(f'<div class="section-header"><span class="section-title">IMPLANTAÇÃO</span><span class="section-total">R$ {t_imp:,.2f}</span></div>', unsafe_allow_html=True)
...
with col2:
    ...
    placeholder_men.markdown(f'<div class="section-header"><span class="section-title">MENSALIDADE</span><span class="section-total">R$ {t_men_liq:,.2f}</span></div>', unsafe_allow_html=True)
...
with col3:
    ...
    placeholder_des.markdown(f'<div class="section-header"><span class="section-title">DESPESAS</span><span class="section-total">R$ {t_desp:,.2f}</span></div>', unsafe_allow_html=True)
